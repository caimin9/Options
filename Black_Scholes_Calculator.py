...
# Pricing an option using simulations to act as a comparison to the black-scholes calculation
...
# Below are the outputs to the streamlit UI


st.title('Black-Scholes Option Pricing Model') # Title of UI
S = st.number_input('Stock Price', min_value=0.01, max_value=100000.0, value=100.0) # Initial Price
K = st.number_input('Strike Price', min_value=0.01, max_value=100000.0, value=100.0) # Strike
T = st.number_input('Time to Maturity', min_value=0.01, max_value=10.0, value=1.0) # Time
r = st.number_input('Risk-Free Rate', min_value=0.0, max_value=1.0, value=0.05) # Int Rate
sigma = st.number_input('Volatility', min_value=0.0, max_value=1.0, value=0.2) # Vol
option_type = st.selectbox('Option Type', ['call', 'put'])


#Calculating the price of option using BS & MC and also the Greeks
...
# Plot the graph of option price vs time
...
#Plotting the Delta and Gamma versus time
